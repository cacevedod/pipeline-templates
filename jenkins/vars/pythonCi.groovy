...
def call(Map config = [:]) {
    ...
    // Nota: Para que los Quality Gates funcionen correctamente, es necesario configurar un webhook
    // en SonarQube que apunte a: http://jenkins:8080/sonarqube-webhook/
    ...
    pipeline {
        ...
        stages{
            ...
            stage('Análisis y Build en Paralelo') {
                parallel {
                    // RAMA 1: SonarQube + Quality Gate
                    ...
                    // RAMA 2: Checkov seguido de Docker Build
                    stage('Análisis de Seguridad y Construcción') {
                        stages {
                            // Etapa Checkov (opcional)
